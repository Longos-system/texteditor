...
Item {
    ...
    DocumentHandler {
        ...
        backgroundColor: LongUI.Theme.backgroundColor
        enableSyntaxHighlighting: true
        theme: LongUI.Theme.darkMode ? "Breeze Dark" : "Breeze Light"
    ...
    MenuBar {
        ...
        Menu {
            ...
            MenuItem {
                text: qsTr("About LongOS Text editor")
    ...
    LongUI.AboutDialog {
        ...
        description: qsTr("A text editor specifically designed for LongOS.")
        iconSource: "image://icontheme/long-texteditor"
    }
    ...
    ScrollView {
        ...
        Flickable {
            ...
            TextArea.flickable: TextArea {
                ...
                leftPadding: _linesCounter.width + LongUI.Units.smallSpacing
                padding: LongUI.Units.smallSpacing
...
//                }
                ...
                Label {
                    ...
                    color: isCurrentItem ? LongUI.Theme.highlightColor
